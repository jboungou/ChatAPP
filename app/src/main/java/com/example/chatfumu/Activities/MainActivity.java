...
import com.example.chatfumu.adapter.RecentConversationsAdapter;
import com.example.chatfumu.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void init(){
        ...
        conversationAdapter = new RecentConversationsAdapter(conversations);
        binding.conversionsRecyclerView.setAdapter(conversationAdapter);
        database = FirebaseFirestore.getInstance();
    }
    private void setListeners(){
        binding.imageSignout.setOnClickListener(view -> signOut());
        binding.fabNiewChat.setOnClickListener(view -> {
