...
public class ChatActivity extends AppCompatActivity {
    ...
    private void sendMessage(){
        ...
        messages.put(Constants.KEY_RECEIVER_ID, receiverUser.id);
        messages.put(Constants.KEY_MESSAGE, binding.inputMessage.getText().toString());
        messages.put(Constants.KEY_TIMESTAMP, String.valueOf(new Date()));
        database.collection(Constants.KEY_COLLECTION_CHAT).add(messages);
